...
public class X_HR_Payroll extends PO implements I_HR_Payroll, I_Persistent 
{
	...
	/** Dinero Electrónico = DE */
	public static final String PAYMENTRULE_DineroElectrónico = "DE";
	/** Efectivo = E */
	public static final String PAYMENTRULE_Efectivo = "E";
	/** Cuentas Cruzadas = R */
	public static final String PAYMENTRULE_CuentasCruzadas = "R";
	/** Set Payment Rule.
		@param PaymentRule 
