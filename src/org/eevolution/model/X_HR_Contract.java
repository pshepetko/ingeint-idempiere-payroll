...
public class X_HR_Contract extends PO implements I_HR_Contract, I_Persistent 
{
	...
	/** Set Is Main.
		@param HR_IsMain Is Main	  */
	public void setHR_IsMain (boolean HR_IsMain)
	{
		set_Value (COLUMNNAME_HR_IsMain, Boolean.valueOf(HR_IsMain));
	}

	/** Get Is Main.
		@return Is Main	  */
	public boolean isHR_IsMain () 
	{
		Object oo = get_Value(COLUMNNAME_HR_IsMain);
		if (oo != null) 
		{
